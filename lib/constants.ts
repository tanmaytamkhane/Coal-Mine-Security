...
export const INITIAL_SENSOR_NODES: SensorNode[] = [
  ...
  {
    id: 'NODE-SF-POT-02',
    name: 'Tension Fissure Potentiometer POT-02',
    hardwareModel: 'Linear Potentiometer 100mm Extensometer',
    domain: 'surface',
    type: 'linear_pot',
    unit: 'mm',
    location: 'Overburden Surface Fissure Zone SF-02',
    depthMeters: 0,
    currentValue: 0.85,
    baselineValue: 0.80,
    ...
    zigbeeHops: 1,
    lastUpdated: 'Just now',
    rawSignal: 'ADC 12-bit: 70/4095 (0.056V)',
  },
  {
    id: 'NODE-SF-MPU-01',
